...
public class BannerAdapter extends RecyclerView.Adapter<BannerAdapter.ViewHolder> {
    ...
    protected BannerAdapter.ItemListener mListener;

    public BannerAdapter(Context context, ArrayList<AllServiceModel> values, BannerAdapter.ItemListener itemListener) {
        mValues = values;
        mContext = context;
...
//            relativeLayout.setBackgroundColor();
    ...
    @Override
    public void onBindViewHolder(BannerAdapter.ViewHolder viewHolder, int position) {
